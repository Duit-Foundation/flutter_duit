...
class GestureDetectorAttributes
  ...
  GestureDetectorAttributes copyWith(other) {
    return GestureDetectorAttributes(
      ...
      onVerticalDragStart: other.onVerticalDragStart ?? onVerticalDragStart,
      onVerticalDragDown: other.onVerticalDragDown ?? onVerticalDragDown,
      onVerticalDragUpdate: other.onVerticalDragUpdate ?? onVerticalDragUpdate,
      onVerticalDragEnd: other.onVerticalDragEnd ?? onVerticalDragEnd,
      onHorizontalDragStart:
          other.onHorizontalDragStart ?? onHorizontalDragStart,
      onHorizontalDragUpdate:
          other.onHorizontalDragUpdate ?? onHorizontalDragUpdate,
      onHorizontalDragEnd: other.onHorizontalDragEnd ?? onHorizontalDragEnd,
      onHorizontalDragCancel:
          other.onHorizontalDragCancel ?? onHorizontalDragCancel,
      onVerticalDragCancel: other.onVerticalDragCancel ?? onVerticalDragCancel,
      ...
      onScaleStart: other.onScaleStart ?? onScaleStart,
      onScaleUpdate: other.onScaleUpdate ?? onScaleUpdate,
  ...
  factory GestureDetectorAttributes.fromJson(JSONObject json) {
    return GestureDetectorAttributes(
      ...
      onVerticalDragStart: ServerAction.fromJSON(json["onVerticalDragStart"]),
      onVerticalDragDown: ServerAction.fromJSON(json["onVerticalDragDown"]),
      onVerticalDragUpdate: ServerAction.fromJSON(json["onVerticalDragUpdate"]),
      onVerticalDragEnd: ServerAction.fromJSON(json["onVerticalDragEnd"]),
      onHorizontalDragStart:
          ServerAction.fromJSON(json["onHorizontalDragStart"]),
      onHorizontalDragUpdate:
          ServerAction.fromJSON(json["onHorizontalDragUpdate"]),
      onHorizontalDragEnd: ServerAction.fromJSON(json["onHorizontalDragEnd"]),
      onHorizontalDragCancel:
          ServerAction.fromJSON(json["onHorizontalDragCancel"]),
      onVerticalDragCancel: ServerAction.fromJSON(json["onVerticalDragCancel"]),
      ...
      onScaleStart: ServerAction.fromJSON(json["onScaleStart"]),
      onScaleUpdate: ServerAction.fromJSON(json["onScaleUpdate"]),
      onScaleEnd: ServerAction.fromJSON(json["onScaleEnd"]),
