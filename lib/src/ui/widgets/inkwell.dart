...
class _DuitInkWellState extends State<DuitInkWell>
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      enableFeedback: attributes.getBool("enableFeedback", defaultValue: true),
      excludeFromSemantics:
          attributes.getBool("excludeFromSemantics", defaultValue: true),
      autofocus: attributes.getBool("autofocus", defaultValue: true),
      canRequestFocus:
          attributes.getBool("canRequestFocus", defaultValue: true),
      onTap: performAction(
        context,
        widget.controller,
